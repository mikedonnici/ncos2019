    ...
    <div class="container">
      <div class="content">
        ...
        <p>
          ...
          daily challenges that can impact their success at school. These range from ongoing stress and
          lack of family support to a specific traumatic event.
        </p>
        <p>
          This session builds on from last year's session called 'Trauma Informed Practice'; however,
          you will benefit from this session whether or not you attended last year. This session will
          provide you with a toolkit of activities, ideas and strategies to use in your classroom.
        </p>
        ...
        <p>
          ...
          meaningful way using basic recycled and readily available resources. You will be given the
          chance to undertake a variety of experiments that can be modified and used for all age groups
          and cost very little. The experiments are designed to link with the Stage 1-3 syllabus, but could
          also be utilised in Stage 4-6 support classes. We will also discuss the correct metalanguage
          to be used in teaching Science along with how to conduct a student focussed, inquiry based
        ...
        <p>
          ...
          you will engage with a number of numeracy activities using minimal equipment such as dice and cards,
          and be introduced to some great online resources. You will return to your classroom ready to
          encourage your students to explain their strategies, justify their answers and develop a positive
          mindset around numeracy. Importantly, these activities can be differentiated for use in K-6 classrooms.
        ...
        <p>
          ...
          management to restorative justice practices. It will outline the challenges and successes for all
        ...
        <p>
          ...
          process between the student, parents/carers and teachers, to identify, organise and apply
          personal approaches to learning and engagement. Personalised Learning Pathways can have short
        ...
        <ul>
          ...
          <li>Goal setting and why it is important and why PLP's should be used as a working document</li>
        ...
        <p>
          ...
          extensively in the media industry. It is useful for both primary and secondary teachers who wish to
          create high-quality video presentations for classes or assemblies, as well as for secondary students
          as a learning tool. We will also discuss file formats and hardware requirements. No prior knowledge
          is necessary.
        </p>
        ...
        <p>
          ...
          Bomaderry High School. The aim of this project is to engage in strong collaborations between parents,
          students and staff. The desired outcome of this project is increased educational aspiration and ensured
          continuity and ongoing improvement of learning for all students. All students will be known, valued and
          cared for.
        </p>

        <p>
          Participants will be supported to begin unpacking the Middle Years (5-9) Transition Matrix, created by
          NSW Department of Education 2012. Participants will be able to self-assess their school’s current
        ...
        <p>
          Participants will learn about some practical strategies designed to support successful
          transition so that students are able to seamlessly shift from primary to secondary school
        ...
        <p>
          ...
          overview of a process which demonstrates; How teachers are able to engage in professional dialogue,
          collaboration and classroom observation to monitor, plan and inform their teaching and meet the
          learning needs of their students.
        </p>

        <p>
          Using the Syllabus and Learning Progressions, participants will see how they can be responsive to
          meeting the needs of their students through a process of analysis, goal setting, teaching and
          assessment. Participants will have opportunities to see how quality, valid and reliable data is
          collected through the teaching and learning cycle as evidence for teacher discussions and further
          class intentions.
        </p>
        ...
        <p>
          ...
          student’s engagement at School. Much acting out behaviour is a result of students having poor
          receptive and /or expressive communication skills. Topics covered will include; communication
          principles for staff interacting with students, basic visuals for supporting student's communication
          and introductory tips for using the iPad for communication. Participants will be provided with
        ...
        <p>
          Seesaw is a platform for student engagement. Teachers can empower students to create,
          reflect, share, and collaborate. Students “show what they know” using photos, videos,
          drawings, text, PDFs, and links. It’s simple to get student work in one place and share
        ...
        <p>
          ...
          in the classroom setting. Participants will be provided with professional learning resources and
          examples of school support structures to upskill parents and volunteers, helping to build effective
        ...
        <p>
          ...
          then collaboratively discuss and explain their strategies with their classmates. During number
          talks, students have the opportunity to justify and prove their thinking, investigate and apply
          mathematical relationships, build a repertoire of efficient strategies and select the most efficient
        ...
        <p>
          ...
          Emotional Regulation and Visible Learning. I will run through a program called the Zones Of Regulation,
          which is a practical program enabling students to learn how to self-regulate, also providing ongoing
          tools to allow this skill to be generalised. You will view visible learning strategies which have enabled
          success in the ED classroom via individual learning plans and strategies. Many of these strategies
        ...
        <p>
          ...
          method of teaching music to children. The session will begin with Orff's approach to teaching
          infants music using chant and body percussion to primary music with simple songs and instrumental
          accompaniment, then moving to stage 4 and onwards with pentatonic scales and chords progressions.
        </p>

        <p>
          Participants will receive handouts for each arrangement, plus a bonus few to try out back at school.
          We will also discuss how to set up a music lesson and acquire instruments, as well as, ideas on
          how to use easy access instrumentation such as chairs and rubbish bins. By the end of the session,
          applicants will have a greater understanding and confidence in teaching music to any age group.
        </p>

        <p>
          All instruments and resources for the session will be supplied, you only need to bring a voice to
        ...
        <p>
          ...
          and identify how these Aboriginal technologies can be incorporated into a variety of Key Learning Areas
          and Subject Areas. Participating teachers will also gain access to the Northern Shoalhaven CoS- Connecting
        ...
        <p>
          The 2nd component we will look at the "Third Space". What strategies do you use to be ready and
        ...
        <ol>
          ...
          <li>Teaching emotional regulation - the zones, useful resources for your classroom and different ways to use them.</li>
          <li>Using the Motivation Assessment Scale to guide your ABC analysis.</li>
          <li>Completing RCB, IEP, Behaviour Plans etc straight into Sentral and other forms.</li>
          <li>Self-care.</li>
        </ol>
        ...
        <p>
          ...
          activities for use in PE and Sport classes in both primary and High Schools. Participants will be given
        ...
        <p>
          ...
          are not mental health specific such as physical and sexual health, and vocational assistance. The
          referral pathways and steps involved in a young person accessing support from headspace will be explained.
          Discussion on the scope of young people we would see, and when a referral to another service may be more
          appropriate.This will be followed by a question and answer type discussion for any further information
          or any particular concerns attendees might have regarding how to support young people in different
          situations.
        </p>
        ...
        <p>
          ...
          the accreditation processes, navigating etams, meeting your professional learning requirements and
        ...
        <p>
          ...
          or ignored. The importance of being aware of who you are “biologically” is emphasised and steps you
          can/should take to manage this are outlined. A very effective relaxation technique is covered as well.
        </p>
      </div>
    </div>
  </section>
